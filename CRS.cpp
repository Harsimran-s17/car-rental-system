...
class User{         // User class
    ...
    // Unique method used to verify the entered user while registration should be unique
    bool Unique(){
        ifstream inf;
    ...
    // Method for writing a data to file
    void writedata(){
        ofstream outf;
    ...
    // Creating an login method
    int login(){
        Sleep(500);
        system("CLS");
        string userN;
        string passW;
        cout<<"Enter Your Username : ";         //taking data from the user
        cin>>userN;
        Username = userN;
        ifstream newfile;
        string line;
...
class rent : public User{           // inhereted class from customer class
    public:
        ...
        int dis=0;
        int rentalfee1;
        // additional int vatiables defined
        void chooseCar(){
            do
            {
                Sleep(1000);
                ...
                // Providing options for choosing a car company
    ...
    void feedback(){
        ...
        int choice;
        char suggestion[500];
        cout<<"Enter '1' if you like to fill feedback form or Enter '0' to continue : ";
        cin>>choice;
        if(choice == 1){
            cout<<"\n\t\t\t\t\tPlease rate our app out of 5.00 : ";
            cin>>rate;
            cout<<"\n\t\t\t\t\tAny Suggestion(if None please type 'None') : " ;
            fflush(stdin);
            cin.getline(suggestion,500);
            ofstream ratef("feedback.txt", ios::app);
            ratef<<Username<<"\t\t\t"<<rate<<"\t\t\t\t\t"<<suggestion<<endl;
            ratef.close();
        }
        else if(choice == 0){
            return;
    ...
    switch(j){
        case 1:
        {
            ...
            if(passWd.compare("Password123") == 0){
                ...
                Sleep(1000);
                system("CLS");
                cout<<"\n\n\t\t\t\tEnter '1' to Know all records of rentals till today\n\t\t\t\tEnter '0' to see Customer feedbacks\n\n\t\t\t\tEnter your choice here : ";
                cin>>choice2;
                if(choice2 == 1){
                    system("CLS");
                    ...
                    system("CLS");
                    cout<<"Showing all the feedbacks given by Customers.....\n\n";
                    Sleep(1000);
                    ifstream filerec;
                    filerec.open("feedback.txt");
                    while(filerec){
                        filerec.getline(lineR,1000);
                        if(filerec){
                            cout<<lineR<<endl;
